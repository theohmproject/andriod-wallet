...
public class OhmModuleImp implements OhmModule {

    private static final Logger logger = LoggerFactory.getLogger(OhmModuleImp.class);
    ...
    public OhmModuleImp(ContextWrapper contextWrapper, WalletConfiguration walletConfiguration, ContactsStoreDao contactsStore, RateDbDao rateDb, BackupHelper backupHelper) {
...
//                    }
   ...
   public boolean isSyncWithNode() throws NoPeerConnectedException {
    ...
    public void saveRate(OhmRate ohmRate){
        rateDb.insertOrUpdateIfExist(ohmRate);
    }
