package ohm.org.ohmwallet.ui.words_restore_activity;
...
import static ohm.org.ohmwallet.module.Coin2PlayContext.Coin2Play_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = ohmModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            ohmModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            ohmModule.restoreWallet(mnemonic, Coin2Play_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (ohmApplication.getAppConf().getPincode() != null){
                                                        ...
                                                        if(!ohmApplication.getAppConf().isAppInit()){
