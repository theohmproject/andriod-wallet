package ohm.org.ohmwallet.ui.splash_activity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri video;
        if(OhmApplication.getInstance().getAppConf().isSplashSoundEnabled())
    ...
    private void jump() {
        ...
        if (OhmApplication.getInstance().getAppConf().isAppInit()){
            Intent intent = new Intent(this, WalletActivity.class);
            startActivity(intent);
        }else {
