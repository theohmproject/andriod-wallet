package ohm.org.ohmwallet.ui.import_watch_only;
...
import ohm.org.ohmwallet.ui.base.dialogs.DialogListener;
import ohm.org.ohmwallet.ui.base.dialogs.SimpleTextDialog;
import ohm.org.ohmwallet.utils.DialogsUtil;

import static ohm.org.ohmwallet.utils.CrashReporter.appendSavedBackgroundTraces;

/**
 * Created by ras on 8/30/17.
 */
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                ohmModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32: DeterministicKeyChain.KeyChainType.BIP44_OHM_ONLY
                );
