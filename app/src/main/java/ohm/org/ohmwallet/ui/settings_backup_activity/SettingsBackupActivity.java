package ohm.org.ohmwallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = ohmModule.backupWallet(backupFile, firstPassword);

            if (result){
                ohmApplication.getAppConf().setHasBackup(true);
