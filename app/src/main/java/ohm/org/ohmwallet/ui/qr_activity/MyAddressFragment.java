...
import static ohm.org.ohmwallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(OhmModule ohmModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(ohmModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = OhmApplication.getInstance().getModule();
    ...
    public void setModule(OhmModule module) {
        this.module = module;
    }
